...
const STATUS_TRANSITIONS = Object.freeze({
  ...
  [STATUSES.REPLY_RECEIVED]: [STATUSES.NEEDS_MANUAL_REVIEW, STATUSES.REPLY_POSTED],
  [STATUSES.NEEDS_MANUAL_REVIEW]: [STATUSES.REPLY_POSTED, STATUSES.FAILED, STATUSES.QUEUED],
  [STATUSES.REPLY_POSTED]: [STATUSES.COMPLETED],
  [STATUSES.COMPLETED]: [],
