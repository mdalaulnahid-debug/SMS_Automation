...
## Corpus Check
- 128 files · ~357,712 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1601 nodes · 2644 edges · 105 communities (96 shown, 9 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 166 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1af0855f`
...
Cohesion: 0.06
Nodes (14): assertTransition(), createRequestId(), normalizePhoneNumber(), normalizeSenderId(), TERMINAL_DISPATCH_STATUSES, AutomationStore, canonicalize(), { createHash } (+6 more)
...
Cohesion: 0.18
Nodes (3): AutomationService, formatCombinedReply(), requestStatusRank()
...
Cohesion: 0.23
Nodes (11): createApp(), json(), { existsSync, readFileSync }, { join }, loadAuthConfig(), loadGatewayConfig(), loadMailConfig(), loadTelegramConfig() (+3 more)
...
Cohesion: 0.28
Nodes (7): DISPATCH_STATUSES, isTrustedSenderForGateway(), operatorForGateway(), operatorForMsisdn(), REQUEST_DEFINITIONS, STATUS_TRANSITIONS, targetOperatorsForRequest()
...
Cohesion: 0.28
Nodes (8): assert, call(), { createApp }, mockReq(), mockRes(), { Readable }, test, { UserAuthStore }
...
Cohesion: 0.05
Nodes (35): 10. Reply Drafting and Posting, 11. Security Model, 12. Failure Modes and Recovery, 13. Testing Strategy, 14. Planned extensions, 15. Workstation portability, 1. Purpose, 2. Topology (+27 more)
...
## Knowledge Gaps
- **544 isolated node(s):** `Status by component (rollout order per design doc's Testing & rollout section)`, `Latest update`, `Decisions (resolved 2026-07-07)`, `What this is`, `Explicitly OUT OF SCOPE for this phase — do not build, suggest, or stub any of` (+539 more)
...
- **What connects `Status by component (rollout order per design doc's Testing & rollout section)`, `Latest update`, `Decisions (resolved 2026-07-07)` to the rest of the system?**
